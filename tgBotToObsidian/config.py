...
tgBot2ObsToken = 01234567890:qwertyuiop[]';lkjhgfdsazxcvbnm,./']
...
# Path to the folder where received animations should be stored
...
audio_path = r'C:\Users\Youri\Основное хранилище Obsidian\Телеграм\attachments'
...
# If True, voice (audio) messages will be recognized to text.
